...
class AlunoAdmin(admin.ModelAdmin):
    list_display = ('id_aluno', 'nome', 'nome_social', 'cpf', 'serie', 'periodo')  # Campos a serem exibidos na lista
    search_fields = ('nome', 'nome_social', 'id_aluno', 'cpf')  # Campos que você pode pesquisar no admin
